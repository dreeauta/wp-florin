...
class SP_PC_Admin_Scripts {
	...
	public function admin_scripts() {
		if ( 'sp_pc_shortcodes' === get_current_screen()->id ) {
			...
			wp_enqueue_style( 'sp-pc-admin-meta-style', SP_PC_URL . 'admin/assets/css/admin-meta.css', false, SP_PC_VERSION );
		...
		wp_enqueue_style( 'sp-pc-admin-style', SP_PC_URL . 'admin/assets/css/admin.css', false, SP_PC_VERSION );
		wp_enqueue_style( 'sp-pc-font', SP_PC_URL . 'public/assets/css/spfont.css', false, SP_PC_VERSION );
	}
