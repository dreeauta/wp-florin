...
This video will help you get started with the plugin.', 'post-carousel' ); ?></p>
            ...
            <div class="headline-feature feature-video">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/xncMA8ogyZw?rel=0" frameborder="0" allowfullscreen></iframe>
            </div>
            ...
            <div class="feature-section three-col">
                <div class="col">
                    <div class="sp-pc-feature sp-pc-text-center">
                        <i class="sp-pc-font-icon icon-lifebuoy">&#xf1cd;</i>
                ...
                <div class="col">
                    <div class="sp-pc-feature sp-pc-text-center">
                        <i class="sp-pc-font-icon icon-doc-text-inv">&#xf15c;</i>
                ...
                <div class="col">
                    <div class="sp-pc-feature sp-pc-text-center">
                        <i class="sp-pc-font-icon icon-bug">&#xf188;</i>
            ...
            <div class="sp-pc-pro-features">
                ...
                <div class="feature-section three-col">
                    ...
                    <div class="col">
                        <div class="sp-pc-feature">
                            <h3><span class="dashicons dashicons-yes"></span>Unlimited Color & Styling Options</h3>
	 ...
	 * @return string|void
	 */
	function change_publish_button( $untranslated_text, $translated_text ) {
		if ( 'sp_pc_shortcodes' == get_post_type()){
			//make the changes to the text
			switch( $untranslated_text ) {

				case 'Publish':
					$translated_text = __('Create Carousel', 'post-carousel');
					break;

				case 'Update':
					$translated_text = __( 'Update Carousel','post-carousel' );
					break;
